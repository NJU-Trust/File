...
- sort和filter说明
  ...
  | interestRate                 | double | 百分制                                                       |
  | repaymentDuration            | int    | 还款周期（文档中说的是借款期限）                             |
  | userfailedSubjects           | int    | 挂科数                                                       |
  | userCreditRating             | string | 借款人信用等级（文档中为借款人等级） AA\|A\|B\|C\|D          |
  | userRankingRate              | double | 排名率，百分制                                               |
  | classification(small target) | string | DAILY_EXPENSE\|CONCERT\|GAME_MOVIE_MUSIC\|TRAVEL\|ELECTRONIC_DEVICE\|OTHER\|TEST_TRANSCRIPT\|CERTIFICATE_TEST\|TRAIN\|PROFESSIONAL_QUALIFICATION\|EXCHANGE_PROJECT |
  | classification(large target) | string | CERTIFICATE_TEST\|EXCHANGE_PROJECT\|GMAT\|TOEFL\|IELTS       |
...
param {
    ...
    "filters" : [
        {
            "key" : "userFailedSubjects|userCreditRating|userRankingRate|classification",
            "operation" : ">|<|:",
            "value" : "string"
        }
    ]，
...
param {
    ...
    "filters" : [
        {
            "key" : "userCreditRating|classification",
            "operation" : ">|<|:",
            "value" : "string"
        }
    ],
...
| 名称              | 类型   | 说明                                                         |
| ----------------- | ------ | ------------------------------------------------------------ |
| classification    | string | DAILY_EXPENSE\|CONCERT\|GAME_MOVIE_MUSIC\|TRAVEL\|ELECTRONIC_DEVICE\|OTHER\|TEST_TRANSCRIPT\|CERTIFICATE_TEST\|TRAIN\|PROFESSIONAL_QUALIFICATION\|EXCHANGE_PROJECT |
| money             | double | \> 0                                                         |
| repaymentDuration | int    | 还款周期（文档中说的是借款期限）                             |
| interestRate      | double | 百分制                                                       |
| userCreditRating  | string | 借款人信用等级（文档中为借款人等级） AA\|A\|B\|C\|D          |
...
param
{
    "filters" : [
        {
            "key" : "classification|money|repaymentDuration|interestRate|userCreditRating",
            "operation" : ">|<|:",
            "value" : "string"
        }
    ]
