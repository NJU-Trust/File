...
| url                      | 说明                   |
| ------------------------ | ---------------------- |
| loan/repayment/info/ep   | 等额本金具体数据       |
| loan/repayment/info/eipi | 等额本息具体数据       |
| loan/repayment/info/otp  | 一次性还付本息具体数据 |
| loan/repayment/info/pi   | 先息后本具体数据       |
...
```json
url : "loan/repayment/info/ep"
url : "loan/repayment/info/eipi"
url : "loan/repayment/info/otp"
url : "loan/repayment/info/pi"
...
param {
    "sort" : "money|startTime|interestRate|repaymentDuration|userCreditScore(,asc|desc)",
    "money" : [0, 0], 
    "time" : ["", ""], 
    "interestRate" : [0, 0],
    "repaymentDuration" : [0, 0],
